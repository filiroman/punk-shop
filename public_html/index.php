	...
	<div id="main">
		...
		<div id="result">
			...
			<div class="item">
				...
				<p class="item_name"><a href="item.php">Новый диван</a></p></br>
				<p class="item_date">20.03.2012</p>
				<p class="item_author"><a href="user.php">Ольга</a></p></br>
			...
			<div class="item">
				...
				<p class="item_name"><a href="item.php">монитор Acer V193HQVBb</a></p></br>
				<p class="item_date">15.03.2012</p>
				<p class="item_author"><a href="user.php">Дмитрий</a></p></br>
			...
			<div class="item">
				...
				<p class="item_name"><a href="item.php">Холодильник</a></p></br>
				<p class="item_date">14.03.2012</p>
				<p class="item_author"><a href="user.php">Василий</a></p></br>
			...
			<div class="item">
				...
				<p class="item_name"><a href="item.php">Ночь веcелого студента</a></p></br>
				<p class="item_date">10.03.2012</p>
				<p class="item_author"><a href="user.php">Blackout</a></p></br>
